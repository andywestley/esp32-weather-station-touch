...
const String OPEN_WEATHER_MAP_API_KEY = "bba3dc0bbfba216da0a476c532a83945";
 ...
 */
const String OPEN_WEATHER_MAP_LOCATION_ID = "2638530";
const String DISPLAYED_LOCATION_NAME = "Sandy, UK";
